    ...
    >
      <div class="mb-8 flex items-start sm:gap-4">
        ...
        <div>
          ...
          <h1 class="mb-2 text-3xl font-bold">Ngoccoder</h1>
          <p>
        ...
        <div class="grid-col col-span-1 grid gap-8">
          ...
          <div>
            ...
            <p class="mb-2">
              ...
              <a
                href="https://github.com/nuhoangcodon99?tab=repositories"
                target="_blank"
